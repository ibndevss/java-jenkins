...
@Repository
public class GroupKonversiRepositoryImpl implements GroupKonversiRepository {
	...
	public List<SearchBrowseDto> getBrowse() {
		// TODO Auto-generated method stub
		 List<SearchBrowseDto> result = new ArrayList<>();
			String sql = " select distinct gkonv as Kode,ket as Keterangan from "+t.getTenantId()+".fgkonv order by gkonv";
