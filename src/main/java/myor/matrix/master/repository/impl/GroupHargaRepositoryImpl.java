...
@Repository
public class GroupHargaRepositoryImpl implements GroupHargaRepository {
	...
	public List<SearchBrowseDto> getBrowse() {
		// TODO Auto-generated method stub
		 List<SearchBrowseDto> result = new ArrayList<>();
			String sql = " select distinct gharga as Kode,ket as Keterangan from "+t.getTenantId()+".fgharga order by gharga ";
