...
@Repository
public class KodePasarRepositoryImpl implements KodePasarRepository {
    ...
    public List<SearchBrowseDto> getBrowseKodePasar() {
		...
		String sql = " select distinct kdpsr as Kode,kdpsrname as Keterangan from "+t.getTenantId()+".fkdpasar ORDER BY kdpsr asc ";
