...
@Repository
public class KlasifikasiRepositoryImpl implements KlasifikasiRepository {
	...
	public List<SearchFromHierarkiBrowseDto> getBrowseKlasifikasi() {
		...
		String sql = " select distinct ctype as Kode,ctypename as Keterangan, type from "+t.getTenantId()+".fclassnew ORDER BY ctype ";
