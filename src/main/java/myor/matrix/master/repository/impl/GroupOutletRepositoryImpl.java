...
@Repository
public class GroupOutletRepositoryImpl implements GroupOutletRepository {
	...
	public List<SearchBrowseDto> getBrowse() {
		...
		String sql = " select distinct grupout as Kode,grupname as Keterangan from "+t.getTenantId()+".fgrupout ORDER BY grupout";
