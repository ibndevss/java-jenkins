...
@Repository
public class OutletChainRepositoryImpl implements OutletChainRepository {
	@Autowired
	...
	public List<SearchBrowseDto> getBrowse() {
		...
		String sql = " select distinct kdind as Kode,indname as Keterangan from "+t.getTenantId()+".findustri order by kdind ";
