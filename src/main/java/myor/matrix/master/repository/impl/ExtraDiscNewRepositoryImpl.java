...
import myor.matrix.master.entity.DiscDistDto;
...
@Repository
public class ExtraDiscNewRepositoryImpl implements ExtraDiscNewRepository{
	@Autowired
	...
	public DiscViewDto getExtraDiscNew(String ap) {
		...
		if(apHir.getFlagHierarki() == 0) {
			sql = "	SELECT kodeap,	"
					...
					+"	 WHERE (tipe = 1 OR tipe = 2) AND kodeap = '"+ap+"'	";
		} else {
			sql = "	SELECT kodeap,	"
					+"	       DECODE (tipe,	"
					+"	               1, '1. Ekstra Diskon 1',	"
					...
					+"	       '0' flagexclude, DECODE (0, 0, 'Tidak', 1, 'Ya') AS exclude,	"
					+"	       DECODE (cetakfaktur,	"
					+"	               1, '1. Nilai',	"
					+"	               2, '2. Persentase'	"
					+"	              ) AS cetakfaktur,	"
		...
		for (Object[] obj : hasil) {
			DiscDto data = new DiscDto((String) obj[0], (String) obj[1], (String) obj[2], (String) obj[3],
					(String) obj[4], (String) obj[5], (String) obj[6], (String) obj[7], (String) obj[8], (String) obj[9], (String) obj[10],
					...
					(String) obj[22], (String) obj[23], (String) obj[24], (String) obj[25], (String) obj[26], (String) obj[27], (String) obj[28],
					(String) obj[29], (String) obj[30], (String) obj[31], (String) obj[32], (String) obj[33], (String) obj[34], ((BigDecimal) obj[35]).doubleValue(),
					...
					(String) obj[56], (String) obj[57], (String) obj[58], (String) obj[59], (String) obj[60], (String) obj[61]
					);
			result.setData(data);
		}
		...
		if(result.getData().getBerlakuKelipatan().equalsIgnoreCase("0")) {
			String sqlRange="";
			if(apHir.getFlagHierarki() == 0) {
				sqlRange = "SELECT kodeap, norange, minrange, makrange, nilai, grupkel FROM "+t.getTenantId()+".ftable167 WHERE kodeap='"+ap+"' ORDER BY norange";
			}else {
			...
			Query query2 = entityManager.createNativeQuery(sqlRange);
			List<Object[]> ranges = query2.getResultList();
			List<DiscRangeDto> rangeResult = new ArrayList<>();
			for (Object[] obj : ranges) {
				DiscRangeDto data = new DiscRangeDto((String) obj[0], ((BigDecimal) obj[1]).doubleValue(), ((BigDecimal) obj[2]).doubleValue(), 
						((BigDecimal) obj[3]).doubleValue(), new Double(Objects.toString(obj[4], "0")), Objects.toString(obj[5], ""));
				rangeResult.add(data);
			}
			result.setRanges(rangeResult);
		}
		/*end range*/
		...
		String sqlProduct = "	SELECT kode,	"
				...
				+"	 WHERE kodeap = '"+ap+"'	";
		Query query3 = entityManager.createNativeQuery(sqlProduct);
		
		List<Object[]> products = query3.getResultList();
		...
		if(result.getData().getFlagChannel().equalsIgnoreCase("1")) {
			...
			Query queryChannel = entityManager.createNativeQuery(sqlChannel);
			List<Object[]> objChannel = queryChannel.getResultList();
	...
	public List<DiscApBrowseDto> getExtraDiscApBrowse() {
		...
		String sql = "	SELECT kodeap, keterangan ,	"
				+"	       DECODE (tipe, 1, 'Extra_1', 2, 'Extra_2') AS tipe,	"
