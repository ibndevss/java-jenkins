...
@Repository
public class SubLokasiRepositoryImpl implements SubLokasiRepository {
    ...
    public List<SearchFromHierarkiBrowseDto> getBrowseSubLokasi() {
		...
		String sql = " select distinct data2 as Kode,data3 as Keterangan, data1 from "+t.getTenantId()+".ftabel07 ORDER BY DATA2 ";
