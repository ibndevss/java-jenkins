...
@Repository
public class RegularDiscNewRepositoryImpl implements RegularDiscNewRepository{
...
//		Start Range
		...
		for (Object[] obj : product) {
			SelectItem<String> datax = new SelectItem<String>((String) obj[1], (String) obj[0]);
			productResult.add(datax);
		}
