...
public class LaporanDiskonReportSummaryByAPDto {
	...
	public LaporanDiskonReportSummaryByAPDto() {
		// TODO Auto-generated constructor stub
	}

	public LaporanDiskonReportSummaryByAPDto(String hEADER, String tGLSISTEM, String tGLGUDANG, String rELEASE,
			String tIPEDISKON, String fILTERAP, String fLAGKLAIM, String fILTERTANGGAL, String pILIHANDISKON,
			String kODEAP, String kETERANGAN, String aWAL, String aKHIR, String sLSNO, String sLSNAME, BigDecimal pCODE,
			BigDecimal dISC, BigDecimal qTY, BigDecimal aMOUNT) {
		super();
		HEADER = hEADER;
		TGLSISTEM = tGLSISTEM;
		TGLGUDANG = tGLGUDANG;
